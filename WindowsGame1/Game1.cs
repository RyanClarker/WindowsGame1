...
namespace WindowsGame1
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Color[] colors = new Color[7] { Color.Red, Color.Blue, Color.Yellow, Color.Purple,
        ...
        protected override void Update(GameTime gameTime)
        {
                ...
                (currentSquare.Contains(mouse.X, mouse.Y)))
            {
                ...
                currentSquare = new Rectangle(
                    rand.Next(0, this.Window.ClientBounds.Width - 25),
                    rand.Next(0, this.Window.ClientBounds.Height - 25),
                                    currentSquare.Width = currentSquare.Width - 16,
                currentSquare.Height = currentSquare.Height - 16);
            }
